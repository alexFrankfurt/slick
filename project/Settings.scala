  ...
  def slickProjectSettings = (
    slickGeneralSettings ++
      ...
      Seq(
        ...
        OsgiKeys.exportPackage := Seq("slick", "slick.*", "scala.slick", "scala.slick.*", "scala.collection.compat", "oracle.sql", "oracle.core.lmx",
          "oracle.jdbc", "oracle.jdbc.aq", "oracle.i18n.text.converter", "oracle.jdbc.dcn", "org.postgresql.util"),
        OsgiKeys.importPackage := Seq(Osgi.osgiImport("!scala.collection.compat,scala*", scalaVersion.value), "*"),
